...
Techie: function PT(selector, context) {
 ...
 this.ready(function(body, head,  doc, $,  _,  w, log, stringify, stringifyAll, element){
    data  = $(selector);
    return cntxt.apply(data, [$, data[0], body, head, doc, _, w, log, stringify, stringifyAll, element]);
}); 
}
  ...
  isready: false,
        ...
        onReady: function onReady(func) {
           ...
           var body = this.body = pt.next(head);
            ...
            if (func && func.call) {
            func.call(this, sapi.body, sapi.head, sapi,  Techie, SAPI, window, Log, stringify, stringifyAll, element);
       }
        },
