...
function EventTarget() {}
  ...
  var Events = EventUtil =  this.EventUtil = EventTarget.prototype = this.Events, contains = this.contains,
   ...
   entechie = this.entechie, log = console.log, logError = console.error, warn = console.warn,
...
return this.ready(function(body, head,  doc,  _, $,  w){
