...
var plain = {
       ...
       isEmptyObject: function isEmptyObject ( obj ) {
        ...
        blob: function blob(bb = String( bb ).trim()){
...
plain: plain,
 error: error,
 strew: function(){
        var evs = ("blur,focus,load,resize,scroll,unload,click,dblclick," +
                "mousedown,mouseup,mousemove,mouseover,mouseout,change,reset,select," + 
                "submit,keydown,keypress,keyup,error").split(","), stb = this;
        evs.forEach(function(name){
            Events[ name ] = Events[ "on" + name ] = function(fn, target){
               stb.delta(stb.cast(this, target), function(){ 
                this.each(function(){//a(this.addHandler)
                    this.addHandler(this, name, fn.bind(this));
                });
                });
            }
        });
    },
 curry: function curry(data, fn, evaluation){//if not done, do it.
...
cast: function cast( sure, optional, boolean ){ //rebase between 2 options
            // nxsb = Techie.cast(this, nxsb, false);
                return optional ? optional: sure;
        },
enclose: function enclose(dada){ //Used to form array when needed
    return is.list(dada) ? dada : [dada];
},
enTechie: function enTechie(d){
    return d ? d.techieString ? d: Techie(d) : error( d + " is not a valid object", null,nl() );
},
plural: function plural(d){
    return is.list(d)? d: [d];
}, 
delta: function delta(ds, fn){
    ds.techieString ? fn.apply(ds, ds): fn.apply( (ds = Techie(ds) ), ds);
},
...
getSelectionString: function getSelectionString(el, win) {
  ...
  walk_the_DOM: function walk(node, func) {
    ...
    each: function forEach ( action, object, This )  {
        ...
        if (object.length) {  length = object.length;
            for (; index < length; index++) {
                if ( action && action.call(This || object[index], object[index], index, object) === false ) {  
                    break; 
                } else{ /*Fix stuff here*/ }
            }
             } else {  for (index in object) {
...
Techie: function PT(selector, context) {
    if (plain.functions(context)) {
     this.ready(context.bind( (context = Techie(selector)), context))
}
...
computedStyle: function computedStyle( dom ) {
        ...
        delta(cast(this, dom), function(dom){
            this.each(function(){
                // a(this) We have all the elements here.
            })
        });
        return true;
...
toggleClass: function toggleClass(name, div){
    ...
    delta(cast(this, is.html(div)? div: null), function(){
        this.each(function(){});//Look the addClass method below
    });
    return this;
},
...
tabForward: function tabForward(event) {
        ...
        }) : setText.call(Techie(parent), text);
            return this;
        },
...
return  this.stack;
        ...
        getLastChild: function getLastChild( element, nodes = [], node = null) {
            delta( cast(this, element), function(){
                this.each(function(P = this){
        ...
        getFirstChild: function getFirstChild( element, nodes = [], node = null) {
            delta( cast(this, element), function(){
                this.each(function(P = this){
                    walk(this, function(e, firstChild, lastChild, parent){ 
                        if (e.parentNode == P) {
...
text: function text(str, parent){//.text().text("meat").text("egg", div)
    ...
    for(; iterator < nodes.length; iterator++ ){
        ...
        parent.techieString ? parent.each(function(p){
            error("html", is.html(p), ln()); 
                    error("string", is.string(str), ln());
                    this.setText(str);
        }, null, this) : text.call(Techie(parent), e);
            return this;
        },
...
//.appendChild(div).appendChild("h2").appendChild("<h1></h1>")
        ...
        Id: function id(id, context) { var e; 
...
var str, collector = [], func, length = arguments.length,error = Techie.error, prop,val;
...
'border': '1px solid olive','margin': 'inherit','font-size': '10px'
        ...
        Log: function Log(text, bool, element) {
            ...
            Techie.PT.ready(function(body, head, doc, PT, _, w) {
                ...
                var error = sapi.createElement("h3"); ore = p + h3 + text + h3close + pclose;
                error  = sapi.createDocumentFragment(ore);
                error.id = "err";
                ...
                a()
                this.prependChild(element, error); //
                Techie.styles(error, { background: "#a9a965",
'margin': '.1em auto','padding': '2em','box-sizing': 'border-box',display: "inline-block", "position": "relative", "width": "100%", "margin-left": "10%",
